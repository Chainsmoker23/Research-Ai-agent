...
import { Search, ArrowRight, Globe, Sparkles, Zap, Atom, ShieldCheck } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="relative group max-w-2xl mx-auto transform transition-all duration-300 hover:scale-[1.02]">
          ...
          <div className="relative">
            ...
            <input
                ...
                className="block w-full pl-12 pr-14 md:pr-12 py-5 bg-white border border-slate-200 rounded-xl text-base md:text-lg shadow-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                disabled={isLoading}
                autoFocus
            />
            <button
