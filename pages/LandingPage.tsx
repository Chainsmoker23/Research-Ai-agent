...
import { ArrowRight, Sparkles, FileText, Cpu, Network, CheckCircle2, Terminal, Radar, ShieldAlert, FlaskConical, Binary, Play, LayoutTemplate, SearchCheck, BarChart3, TestTube2, Download, ExternalLink } from 'lucide-react';
         ...
         <div className="max-w-7xl mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
               ...
               <div className="order-2 lg:order-1 relative flex justify-center py-8 lg:py-0">
                  {/* Container: Responsive Size & Dark Theme for Contrast */}
                  <div className="relative w-[320px] h-[320px] sm:w-[480px] sm:h-[480px] rounded-full flex items-center justify-center bg-[#0f172a] shadow-2xl border border-slate-800 shrink-0 overflow-hidden group">
                     
                     {/* Dynamic Grid Background */}
                     <div className="absolute inset-0 opacity-20 bg-[linear-gradient(rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-[size:40px_40px] [mask-image:radial-gradient(ellipse_at_center,black_60%,transparent_100%)]"></div>
                     
                     {/* Rings */}
                     <div className="absolute inset-[15%] border border-slate-700/60 rounded-full shadow-[0_0_15px_rgba(99,102,241,0.1)]"></div>
                     <div className="absolute inset-[30%] border border-slate-700/60 rounded-full"></div>
                     <div className="absolute inset-[45%] border border-slate-700/60 rounded-full"></div>
                     
                     {/* Scanning Sweep - Conic Gradient */}
                     <div className="absolute inset-0 rounded-full animate-scan-radar z-10">
                        <div className="w-full h-full bg-[conic-gradient(transparent_270deg,rgba(99,102,241,0.3)_360deg)] rounded-full blur-sm"></div>
                     </div>
                     <div className="absolute inset-0 rounded-full animate-scan-radar z-10">
                        <div className="absolute top-0 left-1/2 w-px h-1/2 bg-gradient-to-b from-indigo-400 to-transparent shadow-[0_0_15px_#818cf8]"></div>
                     </div>

                     {/* Center Mascot */}
                     <div className="relative z-20 bg-slate-900 p-4 rounded-full border border-slate-700 shadow-2xl">
                        <LemurMascot className="w-24 h-24 sm:w-32 sm:h-32" variant="telescope" />
                     </div>

                     {/* Blips */}
                     <div className="absolute top-[28%] right-[28%] w-3 h-3 bg-rose-500 rounded-full animate-ping z-20 shadow-[0_0_10px_#f43f5e]"></div>
                     <div className="absolute top-[28%] right-[28%] w-3 h-3 bg-rose-500 rounded-full z-20"></div>
                     ...
                     <div className="absolute bottom-[32%] left-[22%] w-3 h-3 bg-emerald-500 rounded-full z-20"></div>

                     {/* Score HUD - Perfect Position (Bottom Right, Glassmorphism) */}
                     <div className="absolute bottom-10 right-10 sm:bottom-16 sm:right-16 z-30">
                        <div className="backdrop-blur-xl bg-slate-900/60 border border-white/10 p-4 rounded-2xl shadow-2xl flex flex-col items-center animate-float ring-1 ring-white/20">
                            <span className="text-[10px] text-indigo-300 font-bold uppercase tracking-widest mb-1 shadow-black drop-shadow-md">Novelty Score</span>
                            <div className="text-4xl sm:text-5xl font-mono font-bold text-white text-glow drop-shadow-lg">94%</div>
                            <div className="w-full h-1.5 bg-slate-700/50 rounded-full mt-2 overflow-hidden">
                                <div className="h-full bg-gradient-to-r from-indigo-500 to-purple-500 w-[94%] shadow-[0_0_10px_#6366f1]"></div>
                            </div>
                        </div>
                     </div>
                  </div>
